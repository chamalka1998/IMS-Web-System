                ...
                <div class="container-fluid">
                    ...
                    <form>
                        ...
                        <div class="form-row">
                            ...
                            <!-- Third Party Start -->
                            <div class="form-group col-md-6">
                                <label class="mr-sm-2" for="province">Third psrty property damage</label>
                                <select id="province" class="form-control">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="natural_perils">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="theft_part">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="terrorism">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="towing">
