        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Vehicle_register.php">Create New</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities4" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Choose here :</h6>
                        <a class="collapse-item" href="register_admin.php">Add new</a>
                        <a class="collapse-item" href="Customers_list.php">Edit exisist</a>
                    </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities5" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Choose here :</h6>
                        <a class="collapse-item" href="Covers_add.php">Add new</a>
                        <a class="collapse-item" href="Covers_list.php">Edit exisist</a>
